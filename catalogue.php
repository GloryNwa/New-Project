      ...
      <div class="bg">
        <div class="bg-top-shadow">
          <div class="main">
            ...
            <br>
            <h3 class="color-1 p2" style="text-align: center; font-size:36px">Project Archive</h3>
           
               <?php
                   $query = "SELECT * FROM productarchive group BY year  ORDER BY year DESC LIMIT 28";
                       ...
                       ?>
                        <div class="carousel">
                        <h3 class="color-1 p2"><?php echo  $cat; ?>Projects</h3>
                        <a class="prev" href="#">Prev</a> <a class="next" href="#">Next</a><ul id="carousel">
                      <?php
                        $query2 = "SELECT * FROM `productarchive` WHERE `year` = '$cat' ORDER BY year DESC LIMIT 30 ";
                          ...
                          ?>  
                           <li><a href="viewArchive.php?year=<?php echo $query_row['year']; ?>&month=<?php echo $query_row['month']; ?>&summary=<?php echo $query_row['summary']; ?>"><img src='<?php echo "admin/archiveFiles /" .$pic;?>' alt="" style="height: 120px; width: 200px"><span style=""><?php echo  $month; ?></span></a></li>
                          <?php
                            }
                         }
                     ?>
