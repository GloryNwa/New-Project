       ...
       if(!empty($_FILES['file']["name"])){
          ...
          $upload_dir = "recentFiles/";
            ...
            if(move_uploaded_file($tmp_file, $upload_dir."/".$target_file)){
                ...
                $sql = "INSERT INTO recentwork(day, month,year,description,file)";
                $sql .= "VALUES(
                       ...
                       ?>
                        ...
                        <div class="card-body ">
                          ...
                          <div class="form-group">
                            <label for="" class="bmd-label-floating">Day*</label><br>
                            <input type="text" name="day" class="form-control" id="" placeholder="Day 1 for example" required="true" >
                          </div><br>
                           <div class="form-group">
                            <label for="" class="bmd-label-floating">Month*</label>
                            <input type="text" name="month" class="form-control" id="" required="true" >
                          </div>
                           <div class="form-group">
