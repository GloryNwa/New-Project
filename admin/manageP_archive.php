      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Product Archive</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-info card-header-icon">
                  ...
                  <h4 class="card-title">Manage Product Archive</h4>
                </div>
                <div class="card-body">
                  <div class="toolbar">
                  ...
                  <?php if(isset($_SESSION['alert'])){ 
                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                        <?php $sql = "SELECT * FROM productarchive ORDER BY id DESC";
                             $x = 1;
                        ...
                        ?>
                         <tr>
                          ...
                          <td><?php echo $desc;?></td>
                          <td><img src='<?php echo "archiveFiles/" .$pic;?>' alt="" width="150px" hieght="150px" /></td>
                           <td class="text-right">
                             <ul class="nav nav-pills">
                             <li role="presentation">
                               <a href="editArchive.php?id=<?php echo $query_row['id']; ?>">
                                <span class="fa fa-pencil"><button class="btn btn-success btn-xs" style="background-color:#009efb;">Edit</button></span>  
                               </a>
                            </li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <li role="presentation">
                                <a  href='deleteArchive.php?id=<?php echo $query_row['id']; ?>'onclick='return confirm("Are you really sure?")'>
