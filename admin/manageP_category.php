      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Product Category</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-info card-header-icon">
                  ...
                  <h4 class="card-title">Manage Product Category</h4>
                </div>
                <div class="card-body">
                  <div class="toolbar">
                  ...
                  <?php if(isset($_SESSION['alert'])){ 
                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                        <?php $sql = "SELECT * FROM productcategory ORDER BY id DESC";
                             $x = 1;
                             if ($query_run = mysqli_query($connection,$sql)) {
                             
                             while($query_row = mysqli_fetch_assoc($query_run)){
                             
                              $desc = $query_row['category'];
                              // $year = $query_row['year'];
                              $pic = $query_row['file'];
                        ...
                        ?>
                         <tr>
                          ...
                          <!--  -->
                          <td><?php echo $desc;?></td>
                          <td><img src='<?php echo "categoryFiles/" .$pic;?>' alt="" width="150px" hieght="150px" /></td>
                           <td class="text-right">
                             <ul class="nav nav-pills">
                              <li role="presentation">
                               <a href="editCategory.php?id=<?php echo $query_row['id']; ?>">
                                <span class="fa fa-pencil"><button class="btn btn-success btn-xs" style="background-color:#009efb;">Edit</button></span>  
                               </a>
                            </li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <li role="presentation">
                                <a  href='deleteCategory.php?id=<?php echo $query_row['id']; ?>'onclick='return confirm("Are you really sure?")'>
