                          ...
                          <div class="indent-right">
                            ...
                            <?php
                              ...
                              $yr= $_GET['year'];
                                 ...
                                 $query = "SELECT `description`, `month`, `year` FROM `recentwork` WHERE `month`='$mth' AND`year`='$yr' AND `description`='$desc'";
                                  if ($query_run = mysqli_query($connection,$query)) {
                                  ?><h3 class="p0"  style="">Recent & Ongoing Projects</h3><br>
                                   
                                    <strong>Work Summary: </strong> <?php echo $desc . '<br>'; ?>
                                   ...
                                   ?>
                                  <?php
                                      $query2 = "SELECT * FROM `recentwork` WHERE `month`='$mth' AND `year`='$yr' AND `description`='$desc'";
                                      ...
                                      ?>
                                      <p style="font-size:18px"><strong>Day:&nbsp;<?php echo $day;?></strong></p>
                                      <img src='<?php echo "admin/recentFiles /" .$pic;?>'  alt=""style="height:500px;width:100%"><br><br>
