...
if(isset($_POST['submit'])){
      ...
      $tmp_name = $_FILES['file']['tmp_name'];
       ...
       if(!empty($_FILES['file']["name"])){
          ...
          $upload_dir = "archiveFiles/";

            if(move_uploaded_file($tmp_file, $upload_dir."/".$target_file)){
                            
                $sql = "INSERT INTO productArchive(summary, day,year,description,month,file,time)";
                $sql .= "VALUES( 
                     '".mysqli_real_escape_string($connection,$sum) . " ',
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#">Upload Product Archive</a>
          </div>
                     ...
                     <?php if(isset($_SESSION['alert'])){ 
                       ...
                       ?>
                        ...
                        <div class="card-header card-header-rose card-header-icon">
                          ...
                          <h4 class="card-title">Product Archive Form</h4>
                        </div>
                        <div class="card-body ">
                         <div class="form-group">
                            <label for="" class="bmd-label-floating">Project Summary*</label>
                            <input type="text" name="sum" class="form-control" id="" required="true" >
                          </div>
                           <div class="form-group">
                            <label for="" class="bmd-label-floating">Day*</label>
                            <input type="text" name="day" class="form-control" id="" required="true" >
                          </div>
                          <div class="form-group">
                            <label for="" class="bmd-label-floating">Year*</label>
                            <input type="text" name="year" class="form-control" id="" required="true" >
                          </div>
                           <div class="form-group">
                            <label for="" class="bmd-label-floating">Description*</label>
                            <input type="text" name="desc" class="form-control" id="" required="true" maxlength="100">
                          </div><br>
