...
<?php
     $id  = $_GET['id'];
         $query = "SELECT price, picture, description FROM newarrivals WHERE `id`='$id'";
  ...
  // echo "string";exit;
      ...
      $tmp_name = $_FILES['file']['tmp_name'];
       ...
       if(!empty($_FILES['file']["name"])){
         ...
         $query = "UPDATE newarrivals SET description ='".$desc."', price='".$price."', picture='".$target_file."' WHERE id= $id";
              ...
              <div class="card">
                    <form id="" action="" method="POST" enctype="multipart/form-data">
                        <div class="card-header card-header-rose card-header-icon">
                          ...
                          <h4 class="card-title">Edit New Arrival</h4>
                        </div>
                        <div class="card-body ">
