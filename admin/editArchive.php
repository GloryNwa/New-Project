...
<?php
     $id  = $_GET['id'];
         $query = "SELECT month, year, description, file FROM productarchive WHERE `id`='$id'";
...
<?php
$id  = $_GET['id'];
 if(isset($_POST['month'])&&isset($_POST['year']) &&isset($_POST['description'])&&isset($_FILES['file'])){
  // echo "string";exit;
      $pic = $_FILES['file'];
      $month = $_POST['month'];
      $year = $_POST['year'];
      ...
      $tmp_name = $_FILES['file']['tmp_name'];
       ...
       if(!empty($_FILES['file']["name"])){
         ...
         $query = "UPDATE productarchive SET month ='".$month."', year='".$year."', description='".$desc."', file='".$target_file."' WHERE id= $id";
            ...
            if(!$result){
              ...
              header('Location:manageP_archive.php');
          }
       }
                    ...
                    <form id="" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body ">
                         <div class="form-group">
                            ...
                            <input type="text" name="month" class="form-control" id="" required="true"  value="<?php echo $month;?>"> 
                          </div>
                           ...
                           <div class="form-group">
                            ...
                            <input type="text" name="description" class="form-control" id="" required="true" value="<?php echo $desc;?>"> 
                          </div>     
                           <div class="form-group">
